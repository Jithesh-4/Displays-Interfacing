...
const char* city = "ENTER_YOUR_CITY";
const char* country = "ENTER_YOUR_COUNTRY_NAME";
...
void fetchWeatherData() {
  if (WiFi.status() == WL_CONNECTED) {
    ...
    if (httpCode > 0) {
      ...
      weatherData = "CIT IOT WEATHER STATION     Weather: " + String(description) + " Temp: " + String(tempC, 2) + "°C Humidity:" + String(humidity) + "%  Pressure: " + String(pressure) + "hPa Wind: " + String(speed) + " m/s Sunrise: " + String(sunrise) + " Sunset: " + String(sunset);
